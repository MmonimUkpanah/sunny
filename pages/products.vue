<template>
    ...
    <div class="lab">
        ...
        <div class="lab2">
            <h2>PRIVATE LABEL</h2>
            <p>We provide an opportunity for production under a private label using our time-tested formulas or change those according to the client’s needs.</p>
            <img src="/img/priv.jpg" alt="">
        </div>
    </div>
    <back-to-top />
